        ...
        <>
            <Row className="align-items-center">
                <Col>
                    ...
                    <p>Find the perfect meeting spot for you and your friends at Northeastern University!</p>
                </Col>
            </Row>
                ...
                <>
                    <Row className="mb-4">
                        <Col className="text-right">
                            <Link to="/meetup">
                                <Button variant="primary">Create New Meetup</Button>
                            </Link>
                        </Col>
                    </Row>
                        ...
                        <Card>
                            <Card.Body>
                                ...
                                <Link to="/register" className="ml-3">
                                    <Button variant="outline-primary" className="ms-3">Register</Button>
                                </Link>
                            </Card.Body>
                        </Card>
                    </Col>
